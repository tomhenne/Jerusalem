...
import de.esymetric.jerusalem.osmDataRepresentation.OSMRelation;
...
public class Rebuilder implements OSMDataReaderListener {
	...
	private class OSMNodeByDirComparator implements Comparator<OSMNode> {
	...
	private class OSMNodeByOSMIDComparator implements Comparator<OSMNode> {
